...
public class CronSequenceGenerator {
	...
	/**
	 * Construct a {@link CronSequenceGenerator} from the pattern provided, using
	...
	public Date next(Date date) {
		 ...
		 * 
		 * 2 If seconds match move on, otherwise find the next match: 2.1 If next match
		 * is in the next minute then roll forwards
		 * 
		 * 3 If minute matches move on, otherwise find the next match 3.1 If next match
		 * is in the next hour then roll forwards 3.2 Reset the seconds and go to 2
		 * 
		 * 4 If hour matches move on, otherwise find the next match 4.1 If next match is
		 * in the next day then roll forwards, 4.2 Reset the minutes and seconds and go
		 * to 2
		 */
	 ...
	 * @param field
	 *            the field to increment in the calendar (@see {@link Calendar} for
	 *            the static constants defining valid fields)
	 * @param lowerOrders
